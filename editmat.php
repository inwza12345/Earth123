...
<form action="index.php?Node=emat" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">แก้ไขข้อมูลขนม</h3>
            </div>
            <div class="card-body">
    ...
    <input type="hidden" name="met_id" value="<?=$met_id;?>">
              ...
              <div class="form-group">
                <label for="inputName">ชื่อขนม</label>
              ...
              <div class="form-group">
                <label for="inputName">จำนาน</label>
              ...
              <div class="form-group">
                <label for="inputStatus">ประเภทของขนม</label>
...
<?php } ?>
      ...
      <div class="row">
        <div class="col-12">
        <input type="submit" value="บันทึกข้อมูล" class="btn btn-success float-right" name="btsave">
        </div>
      </div>
      <br>
    </section>
